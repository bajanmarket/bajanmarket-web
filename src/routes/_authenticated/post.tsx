    ...
    <AppShell>
      <div className="max-w-2xl mx-auto">
        ...
        <form onSubmit={onSubmit} className="bg-white rounded-3xl ring-1 ring-hairline p-6 flex flex-col gap-5">
          ...
          <Field label="Title">
            <input name="title" required maxLength={120} className={input} placeholder="2018 Suzuki Swift Sport" />
          </Field>

          <Field label="Description">
            <textarea name="description" required minLength={10} maxLength={4000} rows={5} className={input} placeholder="Condition, history, why you're selling…" />
          </Field>

          <div className="grid grid-cols-2 gap-3">
            <Field label="Price (BBD)">
              <input name="price" required type="number" min="0" step="1" className={input} placeholder="0" />
            </Field>
            ...
            <Field label="Condition">
              <select name="condition" required defaultValue="good" className={input}>
          ...
          <label className="flex items-center gap-2 text-sm">
            <input type="checkbox" name="negotiable" defaultChecked className="size-4 accent-teal" />
            Price is negotiable
          </label>
