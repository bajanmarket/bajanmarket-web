...
export function emitEvent(type: CiEventType, payload: CiEventPayload = {}) {
  ...
  try {
    ...
    void supabase.rpc("ci_log_event", {
      _event_type: type,
      _seller_id: payload.sellerId ?? undefined,
      _listing_id: payload.listingId ?? undefined,
      _business_id: payload.businessId ?? undefined,
      _category_id: payload.categoryId ?? undefined,
      _campaign_code: campaign ?? undefined,
      _session_id: sessionId() || undefined,
      _source: source ?? undefined,
      _medium: medium ?? undefined,
      _referrer: referrer || undefined,
      _path: url.pathname,
      _parish: payload.parish ?? undefined,
      _device: info.device,
